...
function tellMe(joke) {
    VoiceRSS.speech({
        key: '43fff0f91ff54943bdc2e340108d815e',
        src: joke,
        hl: 'en-us',
        v: 'Mike',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    // API taken from https://v2.jokeapi.dev/
    const apiURl = 'https://v2.jokeapi.dev/joke/Miscellaneous,Pun,Spooky,Christmas?blacklistFlags=religious,political,racist,sexist';
    try {
